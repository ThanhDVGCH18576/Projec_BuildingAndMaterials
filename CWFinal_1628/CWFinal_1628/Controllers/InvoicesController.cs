...
namespace CWFinal_1628.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Invoice> files = new List<Invoice>();
            foreach (string filePath in filePaths)
            {
                files.Add(new Invoice { InvoiceFile = Path.GetFileName(filePath) });
            }
        ...
        public ActionResult Create( Invoice invoice)
        {
            try
            {
                if (invoice.FileUpload != null)
                {
                    ...
                    invoice.InvoiceFile = "~/Content/images/" + fileName;
                    invoice.FileUpload.SaveAs(Path.Combine(Server.MapPath("~/Content/images/"), fileName));
                }
